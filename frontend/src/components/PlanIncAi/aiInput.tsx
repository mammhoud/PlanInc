...
import AiSetting from '../PlanIncSettings/AiSetting/AiSetting';
  ...
  return (
    ...
    >
      <div className="relative flex items-end gap-2">
        <Textarea
          className={`mt-4 mb-10 !bg-transparent border-none !shadow-none whitespace-pre-wrap ${mode == 'inline' ? 'min-h-[20px]' : 'min-h-[120px]'}`}
          autoFocus
          value={aiStore.input}
          ref={textareaRef}
          onKeyDown={(e) => {
          ...
          placeholder={t('search-planinc-content-or-help-create')}
        />
