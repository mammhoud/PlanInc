...
export const PlanIncMusicPlayer = observer(() => {
        ...
        >
          ...
          >
            {metadata?.coverUrl ? (
              ...
              <>
                <div className="absolute inset-0" style={{ background: 'var(--music-fallback-gradient)' }} />
              ...
              >
                {metadata?.coverUrl ? (
                  ...
                  <div className="w-full h-full bg-muted flex items-center justify-center">
                    <Icon icon="ph:music-notes" className={`${isCompact ? 'w-4 h-4' : 'w-6 h-6'} text-desc`} />
                  </div>
                )}
              </motion.div>
              ...
              <div className="flex-1 min-w-0">
                ...
                >
                  <motion.div className="flex-1">
                    <motion.div
                      className={`truncate ${isPc ? 'max-w-[180px]' : 'max-w-[100px]'} ${metadata?.coverUrl ? 'text-white' : 'text-foreground'}`}
                      animate={{
                    ...
                    <motion.div
                      ...
                      className={`text-sm truncate overflow-hidden ${metadata?.coverUrl ? 'text-white/80' : 'text-desc'}`}
                    >
