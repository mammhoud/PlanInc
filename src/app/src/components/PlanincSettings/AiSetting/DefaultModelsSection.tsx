...
import { ModelIcon, ProviderIcon } from '@/components/PlanIncSettings/AiSetting/AIIcon';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              placeholder={'select'}
              selectedKeys={planinc.config.value?.mainModelId ? [String(planinc.config.value.mainModelId)] : []}
              renderValue={(items) => {
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              selectedKeys={planinc.config.value?.embeddingModelId ? [String(planinc.config.value.embeddingModelId)] : []}
              renderValue={(items) => {
                return items.map((item) => {
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              selectedKeys={planinc.config.value?.voiceModelId ? [String(planinc.config.value.voiceModelId)] : []}
              renderValue={(items) => {
                return items.map((item) => {
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              selectedKeys={planinc.config.value?.imageModelId ? [String(planinc.config.value.imageModelId)] : []}
              renderValue={(items) => {
                return items.map((item) => {
