  ...
  return (
    <div className={`flex w-full h-mobile-full overflow-x-hidden`} id="outer-container">
      ...
      >
        {/* nav bar  */}
        <header
          className="planinc-mobile-header relative flex md:h-16 md:min-h-16 h-14 min-h-14 items-center justify-between gap-2 px-2 md:px:4 pt-2 md:pb-2 overflow-hidden"
          style={!isPc ? {
            position: 'fixed',
            top: 0,
