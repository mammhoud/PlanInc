/**
 * Zod schemas for the data records (validation + tRPC input/output types).
 *
 * These shapes mirror the tables in the SurrealDB data layer (server/db.ts).
 */
import { z } from "zod"
...
export const accountsSelectSchema = z.object({
...
export const configSelectSchema = z.object({
  id: z.boolean().optional(),
...
export const aiProvidersSelectSchema = z.object({
  id: z.boolean().optional(),
...
export const aiProvidersIncludeSchema = z.object({
  models: z.boolean().optional(),
}).strict()
...
export const aiModelsSelectSchema = z.object({
  id: z.boolean().optional(),
...
export const aiModelsIncludeSchema = z.object({
  provider: z.boolean().optional(),
}).strict()
