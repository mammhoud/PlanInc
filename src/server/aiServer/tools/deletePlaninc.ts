...
export const deletePlanIncTool = createTool({
  id: 'delete-planinc-tool',
  description: 'you are a planinc assistant,you can use api to delete planinc,save to database',
  //@ts-ignore
