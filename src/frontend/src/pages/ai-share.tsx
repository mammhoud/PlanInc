...
import { PlanIncChatBox } from "@/components/PlanIncAi/aiChatBox";
    ...
    useEffect(() => {
        const loadConversation = async () => {
            ...
            try {
                ...
                // Set the conversation in aiStore for PlanIncChatBox to display
            ...
            <div className="bg-background/80 backdrop-blur-sm sticky top-0 z-10">
                <div className="max-w-4xl mx-auto px-4 py-3">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="text-xs text-desc">{i18n.t('powered-by-planinc')}</div>
                    </div>
                </div>
            </div>
