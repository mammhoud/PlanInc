  ...
  return (
    <ScrollArea fixMobileTopBar className="mx-auto w-full max-w-5xl space-y-4 px-3 pb-24 md:px-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <Button color="primary" onPress={() => { setEditingItem(null); setIsCrudOpen(true); }} startContent={<Icon icon="material-symbols:add" width="16" height="16" />}>{t('add-study-item')}</Button>
      </div>
