...
export const HotkeySetting = observer(() => {
  ...
  const getCurrentConfig = async () => {
    try {
      const config = await planinc.config.value?.desktopHotkeys;
      const finalConfig = {
        ...
        <div className="flex flex-col gap-4">
          ...
          <Item
            leftContent={
              <ItemWithTooltip
                content="Autostart"
                toolTipContent="Start PlanInc automatically on system boot"
              />
            }
            rightContent={
              <Switch
            ...
            rightContent={
              <div className="flex items-center gap-2">
                <Input
                  ...
                  className={cn("text-center font-mono", isRecording && "ring-2 ring-primary")}
                />
                <Button
                  size="sm"
                ...
                {isQuickNoteNotDefault && (
                  <Button
                    size="icon"
                    variant="ghost"
                    onClick={resetQuickNoteToDefault}
      ...
      >
        <div className="flex flex-col gap-4">
          ...
          <Item
            ...
            rightContent={
              <Switch
                checked={hotkeyConfig.aiEnabled}
                onCheckedChange={(enabled) => saveConfig({ aiEnabled: enabled })}
              />
            }
          />
            ...
            rightContent={
              <div className="flex items-center gap-2">
                <Input
                  ...
                  className={cn("text-center font-mono", isRecordingAI && "ring-2 ring-primary")}
                />
                <Button
                  size="sm"
                  variant={isRecordingAI ? "destructive" : "default"}
      ...
      >
        <div className="flex flex-col gap-4">
          ...
          <Item
            ...
            rightContent={
              <Switch
                checked={hotkeyConfig.textSelectionToolbar?.enabled ?? DEFAULT_TEXT_SELECTION_TOOLBAR_CONFIG.enabled}
          ...
          <Item
            ...
            rightContent={
              <Select
                value={hotkeyConfig.textSelectionToolbar?.triggerModifier ?? DEFAULT_TEXT_SELECTION_TOOLBAR_CONFIG.triggerModifier}
                onValueChange={(modifier: 'ctrl' | 'shift' | 'alt') => {
                  saveConfig({
                    textSelectionToolbar: {
                      ...hotkeyConfig.textSelectionToolbar,
                      ...DEFAULT_TEXT_SELECTION_TOOLBAR_CONFIG,
          ...
          <Item
            ...
            rightContent={
              <div className="flex gap-2">
                <Select
                  value={hotkeyConfig.textSelectionToolbar?.translationFromLang ?? DEFAULT_TEXT_SELECTION_TOOLBAR_CONFIG.translationFromLang}
                ...
                <Select
                  value={hotkeyConfig.textSelectionToolbar?.translationToLang ?? DEFAULT_TEXT_SELECTION_TOOLBAR_CONFIG.translationToLang}
