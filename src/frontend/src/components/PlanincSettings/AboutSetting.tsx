  ...
  return (
    ...
    >
      <div className="flex items-start space-x-4 mb-6">
        <Image src="/logo.png" alt="PlanInc" className="w-16 h-16 rounded-xl" />
        <div>
          ...
          <div className="flex flex-col gap-2 mt-1">
            <div className="flex items-center gap-2">
              ...
              {store.latestServerVersion.value != '' && store.latestServerVersion.value != store.serverVersion.value && (
                <Chip
                  classNames={{
                    base: "bg-gradient-to-br from-secondary to-tag border-small border-white/50 shadow-secondary/30",
