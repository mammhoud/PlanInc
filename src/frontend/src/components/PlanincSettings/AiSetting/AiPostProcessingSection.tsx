...
export const AiPostProcessingSection = observer(() => {
  ...
  useEffect(() => {
    if (planinc.config.value) {
      setIsUseAiPostProcessing(planinc.config.value.isUseAiPostProcessing || false);
      setAiPostProcessingMode(planinc.config.value.aiPostProcessingMode || 'comment');
      setAiCommentPrompt(planinc.config.value.aiCommentPrompt || '');
      setAiTagsPrompt(planinc.config.value.aiTagsPrompt || '');
      setAiSmartEditPrompt(planinc.config.value.aiSmartEditPrompt || '');
      setAiCustomPrompt(planinc.config.value.aiCustomPrompt || '');
    }
