 ...
 *
 * One directory (`src/frontend`) builds every target this product ships to:
...
const APP = join(HERE, '..'); //  src/frontend
...
// `src/frontend` is the one frontend directory: declared as a workspace, and
